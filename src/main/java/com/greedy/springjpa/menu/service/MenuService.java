...
public class MenuService {
	...
	public List<MenuDTO> findAllMenu() {
		...
		return menuList.stream().map(menu -> modelMapper.map(menu, MenuDTO.class)).collect(Collectors.toList());  //람다와 스트림 복습!!!!
	}
	...
	@Transactional
	public void statusModify(MenuDTO menu) {
		
		menuRepository.statusModify(entityManager, modelMapper.map(menu, Menu.class));
	...
	public void menuDelete(MenuDTO menu) {
		...
		menuRepository.menuDelete(entityManager, modelMapper.map(menu, Menu.class));
